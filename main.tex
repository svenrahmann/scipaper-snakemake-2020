...
First, workflow management systems like Galaxy~\parencite{Afgan2018}, often referred to as ``science gateways``~\parencite{Afgan2011-tv}, offer graphical, web-based user interfaces for composition and execution of workflows.
...
Felix Mölder has designed and implemented the job scheduling mechanism (\autoref{sec:scheduling}) and edited the manuscript.
...
This work was supported by the Netherlands Organisation for Scientific Research (NWO) (VENI grant 016.Veni.173.076, Johannes Köster), the German Research Foundation (SFB 876, Johannes Köster), the United States National Science Foundation Graduate Research Fellowship Program (NSF-GRFP) (Grant No. 1745303, Christopher Tomkins-Tinch), and Google LLC (Vanessa Sochat and Johannes Köster).
